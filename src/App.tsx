  ...
  return (
    <div className={`min-h-screen bg-gray-950 ${hasCta ? 'pb-36' : 'pb-8'}`}>
      ...
      <footer className={`text-center py-4 ${hasCta ? 'pb-28' : ''}`}>
        <a href={footerUrl || '#'} target={footerUrl ? '_blank' : undefined} rel="noopener noreferrer" className="text-xs text-gray-600 hover:text-gray-400 transition-colors">Powered by SafeLink</a>
      </footer>
    </div>
  );
}
